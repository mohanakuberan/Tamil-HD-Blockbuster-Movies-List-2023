document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('hd720Button').addEventListener('click', function () {
        ...
        simulateDownload('Chithha HP720/-_Jawan_(2023)_720.mp4', 'Jawan_(2023)_720.mp4');
    });

    document.getElementById('hd480Button').addEventListener('click', function () {
        // Simulate download (replace with actual download logic)
        simulateDownload('Chithha HP480/-_Jawan_(2023)_NQ 480p,360p.mp4', 'Jawan_(2023)_NQ 480p,360p.mp4');
    });

    document.getElementById('hd240Button').addEventListener('click', function () {
        // Simulate download (replace with actual download logic)
        simulateDownload('Chithha HP240/_Jawan_(2023)_LQ_240p.mp4', 'Jawan_(2023)_LQ_240p.mp4');
    });
