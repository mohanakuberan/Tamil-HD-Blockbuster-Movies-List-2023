document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('hd720Button').addEventListener('click', function () {
        ...
        simulateDownload('Chithha HP720/-_Irugapatru_(2023) 720.mp4', 'Irugapatru_(2023) 720.mp4');
    });

    document.getElementById('hd480Button').addEventListener('click', function () {
        // Simulate download (replace with actual download logic)
        simulateDownload('Chithha HP720/-_Irugapatru_(2023) 720.mp4', '-_Irugapatru_(2023) 720.mp4');
    });
