document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('hd720Button').addEventListener('click', function () {
        ...
        simulateDownload('Chithha HP720/-_Ayothi_(2023) 720.mp4', 'Ayothi_(2023) 720.mp4');
    });

    document.getElementById('hd480Button').addEventListener('click', function () {
        // Simulate download (replace with actual download logic)
        simulateDownload('Chithha HP480/Ayothi_(2023) NQ 480p,360p.mp4', 'Ayothi_(2023) NQ 480p,360p.mp4');
    });

    document.getElementById('hd240Button').addEventListener('click', function () {
        // Simulate download (replace with actual download logic)
        simulateDownload('Chithha HP240/-_Ayothi_(2023) LQ_240p.mp4', 'Ayothi_(2023) LQ_240p.mp4');
    });
