document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('hd720Button').addEventListener('click', function () {
        ...
        simulateDownload('Chithha HP720/Por_Thozhil_(2023) 720.mp4', 'Por_Thozhil_(2023) 720.mp4');
    });
    ...
    document.getElementById('hd240Button').addEventListener('click', function () {
        // Simulate download (replace with actual download logic)
        simulateDownload('Chithha HP240/Por_Thozhil_(2023)_LQ_240p.mp4', 'Por_Thozhil_(2023)_LQ_240p.mp4');
    });
